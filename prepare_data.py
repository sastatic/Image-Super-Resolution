...
# path for training and destination  &  #
# setting other parameters like patch-  #
# size, label-size, and scale parameter #
#########################################
DATA_PATH = "./data/"
TEST_PATH = "./data/"
Random_Crop = 30
...
def prepare_data(_path):
    ...
    ###########################################################################
    # This function is used to create image data and its label(s) for testing #
    ###########################################################################
...
def prepare_crop_data(_path):
    ...
    ###########################################################################
    # This function is used to create image data and its label(s) for trainig #
    ###########################################################################
    names = os.listdir(_path)
    names = sorted(names)
    nums = names.__len__()
...
def write_hdf5(data, labels, output_filename):
    ...
    #############################################################
    # This function is used to save image data and its label(s) #
    # to hdf5 file output_file.h5,contain data and label        #
    #############################################################
